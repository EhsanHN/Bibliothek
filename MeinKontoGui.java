 ...
 * @author ehsan
 */
public class MeinKontoGui extends javax.swing.JFrame {

    /**
     * Creates new form MeinKontoGui
     */
    public MeinKontoGui() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField6.setFont(new java.awt.Font("STIXIntegralsUpSm", 1, 18)); // NOI18N
        jTextField6.setForeground(new java.awt.Color(51, 153, 0));
        jTextField6.setText("Mein Konto");
        ...
        jLabel5.setText("Straße und Haus Nr.");
        ...
        jLabel7.setText("Ort und PLZ");

        jButton2.setText("Einloggen");
        ...
        jLabel8.setText("Bist du schon Kunden?");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        dispose();
        web.LoginGui loginGui = new LoginGui();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeinKontoGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MeinKontoGui().setVisible(true);
            }
        });
    }
